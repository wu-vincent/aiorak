...
aiorak is a clean-room RakNet reliable UDP implementation for Python asyncio. It is wire-compatible with RakNet 4.x peers but written from scratch (not ported from C++).
